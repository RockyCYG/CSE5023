...
folders = [
    'results/sentiment-models',
    'results/sentiment-models-no-position'
]
labels = [
    'Original',
...
ax1.set_title('Sentiment: Effect of Positional Encoding')
# 图例放到图内右中间
ax1.legend(lines, labels_combined, loc='center right', bbox_to_anchor=(0.98, 0.5), fontsize='small', frameon=True)
plt.tight_layout(rect=[0, 0, 1, 1])
plt.savefig('compare_no_position.png', bbox_inches='tight')
plt.show()
